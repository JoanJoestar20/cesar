...
_start:
    ...
    call strlen ; call our function to calculate the lengthof the string
...
strlen: ; this is our first function declaration
    ...
    mov ebx , eax ; move the address in EAX into EBX ( Bothpoint to the same segment in memory )
